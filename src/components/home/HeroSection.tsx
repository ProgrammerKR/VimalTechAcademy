              ...
              <div className="relative rounded-2xl bg-white/90 backdrop-blur-md border border-slate-200/80 p-6 shadow-2xl">
                <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <h4 className="text-sm font-bold text-slate-900">Vimal Tech Academy</h4>
                      <p className="text-xs text-emerald-600 font-medium flex items-center gap-1">
                        <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span> Admissions Open 2026-27
                      </p>
                    </div>
                  </div>
